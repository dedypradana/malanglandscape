...
<div class="row margin-bottom-40">
    ...
    <div class="col-md-12 col-sm-12">
        <h1>Malang Landscape Portofolio</h1>
                    ...
                    <?php if($res_gallery){
                        foreach($res_gallery as $gal){ ?>
                            <div class="col-md-3 col-sm-4 mix category_<?php echo @$gal->kategori?> mix_all" style="display: block; opacity: 1; ">
                                <div class="mix-inner">
                                    <img alt="" src="<?php echo base_url('assets/uploads/img/portofolio/thumb__'.$gal->path);?>" class="img-responsive">
                                    <div class="mix-details" style="">
                                        <h4><?php echo @$gal->nama?></h4>
                                        <a href="<?php echo base_url('portofolio/item/'.encode(@$gal->id));?>" class="mix-link"><i class="fa fa-link"></i></a>
                                        <a data-rel="fancybox-button" title="<?php echo @$gal->nama?>" href="<?php echo base_url('assets/uploads/img/portofolio/'.$gal->path);?>" class="mix-preview fancybox-button"><i class="fa fa-search-plus"></i></a>
                                    </div>           
                                </div>                       
                            </div>
                    <?php }}?>
