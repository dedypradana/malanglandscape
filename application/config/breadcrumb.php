 ...
 *
 */
$config['set_home'] = "<i class='fa fa-home'></i> Home";
 ...
 * $config['delimiter'] = ' > ';
 */
$config['delimiter'] = ' <i class="fa fa-angle-right"></i> ';
...
$config['wrapper'] = '<ul class="page-breadcrumb">|</ul>';
$config['wrapper_inline'] = '<li>|</li>';
